...
void Adafruit_MPU6050::getRawTemp(int16_t* temp) {
  *temp = rawTemp;
}

void Adafruit_MPU6050::getRawAccel(int16_t* x, int16_t* y, int16_t* z) {
  *x = rawAccX;
  *y = rawAccY;
  *z = rawAccZ;
}

void Adafruit_MPU6050::getRawGyro(int16_t* x, int16_t* y, int16_t* z) {
  *x = rawGyroX;
  *y = rawGyroY;
  *z = rawGyroZ;
}
